...
export default function DriveTab({
  project, driveLinked, driveTree, driveFolders, driveLoading,
  driveShareEmail, setDriveShareEmail, driveShareRole, setDriveShareRole,
  driveAccessPanel, setDriveAccessPanel, renameModal, setRenameModal,
  appSettings, setProjects, generateProjectCode, copyToClipboard, supabase,
  syncProjectVendors,
}) {
  return (
