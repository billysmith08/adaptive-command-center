...
export default function FinanceTab({
  projects, setProjects, appSettings,
  finFilterMonth, setFinFilterMonth,
  finFilterStatus, setFinFilterStatus,
  finShowSubs, setFinShowSubs,
  expandedRetainers, setExpandedRetainers,
