...
export default function OverviewTab({
  project, projects, clients, contacts, appSettings,
  notesCollapsed, setNotesCollapsed, pctSpent, peopleOptions,
  updateProject, setActiveProjectId, setActiveTab, setProjects, setContacts,
  viewContact, copyToClipboard, updateGlobalContact,
  fmt, Dropdown, DatePicker, TagInput, EditableText, MultiDropdown,
  EditableBudget, ProgressBar, ContactListBlock, AddressAutocomplete,
  RichTextEditor,
  STATUSES, STATUS_COLORS, SERVICE_OPTIONS, SUB_EVENT_STATUSES, SUB_EVENT_STATUS_COLORS,
}) {
  return (
