...
export function TodoistGlobal({
  todoistKey, setTodoistKey, todoistTasks, setTodoistTasks, todoistProjects,
  todoistLoading, todoistNewTask, setTodoistNewTask, todoistFilter, setTodoistFilter,
  todoistEditingTask, setTodoistEditingTask, todoistComments, todoistNewComment, setTodoistNewComment,
  todoistCollaborators, todoistSections,
  todoistFetch, todoistAdd, todoistClose, todoistDelete, todoistUpdateTask, todoistAddComment,
}) {
  const priColors = { 1: "var(--textGhost)", 2: "#3da5db", 3: "#dba94e", 4: "#ff6b4a" };
  const priLabels = { 1: "No priority", 2: "Low", 3: "Medium", 4: "High" };
...
export function TodoistProject({
  project, todoistKey, todoistTasks, setTodoistTasks, todoistProjects, setTodoistProjects,
  todoistLoading, todoistSections, todoistCollaborators,
  todoistEditingTask, setTodoistEditingTask, todoistComments, todoistNewComment, setTodoistNewComment,
  todoistFetch, todoistClose, todoistDelete, todoistCreateProject, todoistAddTaskToProject,
  todoistFetchProjectDetails, todoistAddComment, todoistMoveTask, todoistUpdateTask,
  todoistNewSection, setTodoistNewSection, todoistAddingSection, setTodoistAddingSection,
  todoistNewTaskSection, setTodoistNewTaskSection, adptvWorkspaceId,
  updateProject, generateProjectCode, setClipboardToast,
}) {
  const priColors = { 1: "var(--textGhost)", 2: "#3da5db", 3: "#dba94e", 4: "#ff6b4a" };
  const priLabels = { 1: "No priority", 2: "Low", 3: "Medium", 4: "High" };
