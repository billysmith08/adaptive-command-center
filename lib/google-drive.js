...
export async function ensureVendorFolder(basePath, vendorName) {
  ...
  // Navigate to the base path (e.g., ADMIN/External Vendors/Dec 2025 - Dec 2026/2026 COIs & Workers Comp)
...
// Scan a doc type folder (e.g., "2026 COIs & Workers Comp") and return all vendor subfolders with their files
export async function scanDocTypeFolder(basePath) {
  ...
  // Get all subfolders (vendor folders)
